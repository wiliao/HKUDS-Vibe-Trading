...
- **2026-07-07** ✅ **دفعة PR للمساهمين ووصول IRR-AGL stack**: دُمجت أعمال المساهمين المنتظرة: إعداد IM channel timeout ([#413](https://github.com/HKUDS/Vibe-Trading/pull/413)، شكراً @SyntaxSawdust)، وAlpha Library social previews ودليل المبتدئين ([#396](https://github.com/HKUDS/Vibe-Trading/pull/396)، [#393](https://github.com/HKUDS/Vibe-Trading/pull/393)، شكراً @kadaliao)، وvalue-investing skills / tools / committee presets ([#407](https://github.com/HKUDS/Vibe-Trading/pull/407)، شكراً @sambazhu)، ومعالجة حقول order sizing ذات القيمة الصفرية في `trading_place_order` ([#417](https://github.com/HKUDS/Vibe-Trading/pull/417)، شكراً @irfanallana-oss)، وtimezone-aware UTC timestamps عبر session/API paths ([#397](https://github.com/HKUDS/Vibe-Trading/pull/397)، شكراً @mustafakamal88)، وIRR-AGL reliability/governance stack مع readiness docs وschema fixtures وregression coverage وresearch cards وscorecards وagent evals ([#405](https://github.com/HKUDS/Vibe-Trading/pull/405)، [#416](https://github.com/HKUDS/Vibe-Trading/pull/416)، superseding [#409](https://github.com/HKUDS/Vibe-Trading/pull/409)-[#415](https://github.com/HKUDS/Vibe-Trading/pull/415)، شكراً @Elfsa-Miranda).
